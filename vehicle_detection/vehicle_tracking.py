...
cap = cv2.VideoCapture("A3 A-road Traffic UK HD - rush hour - British Highway traffic May 2017 (1).mp4")
...
image = cv2.resize(frame, (0, 0), ratio, ratio)  # resize image
...
while True:
    ...
    if not ret: #if vid finish repeat
        frame = cv2.VideoCapture("A3 A-road Traffic UK HD - rush hour - British Highway traffic May 2017 (1).mp4")
        continue
